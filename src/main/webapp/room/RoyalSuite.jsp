...
<link rel="stylesheet" type="text/css"
	href="${contextPath}/css/RoyalSuite.css?version=1.7">
<link
	href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css"
	rel="stylesheet"
	integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65"
...
<script type="text/javascript">
	function on_submit() {
		window.location.href = '${contextPath}/reserve/reserveDetail.jsp?room=room3'
	}
</script>
...
<body>
	...
	<div class="wrapper">
		<div id="container">
			<img src="${contextPath}/images/main/room3.1.jpg"> <img
				src="${contextPath}/images/main/room3.2.jpg"> <img
				src="${contextPath}/images/main/room3.3.jpg"> <img
				src="${contextPath}/images/main/room3.4.jpg"> <img
				src="${contextPath}/images/main/room3.5.jpg"> <img
				src="${contextPath}/images/main/room3.6.jpg"> <img
				src="${contextPath}/images/main/room3.7.jpg"> <img
				src="${contextPath}/images/main/room3.8.jpg">
			<button id="prev">&lang;</button>
			<button id="next">&rang;</button>
		</div>
	</div>
	<p class="page_title">로얄 스위트</p>
	<div class=line></div>
						...
						<div class="service-info-list">
							<div class="service-info-listbox">
								...
								<div class="service-info-item">
									...
									<div class="ment">침실1, 욕실3, 주방1, 거실2</div>
								</div>
								<div class="service-info-item">
									<div class="title">침대 타입</div>
									<div class="ment">King Size 1600*2000㎜ 1EA <br>
													  Single 1100*2000㎜ 3EA
									</div>
								</div>
							</div>
						</div>
	...
	<section class="description_section">
		...
		<div class="description">
			단 하나뿐인 최고급 객실로 <br>
			최상의 휴식은 물론 최상의 서비스를 제공하며 <br>
			호텔 그 이상의 가치를 추구합니다. <br> <br>
	...
	<div class= wrap id="wrap">
		<button class="btn_alert" style="padding: 23px; " onclick="location.href='${contextPath}/reserveDetail?room=room3'">객실 예약하기</button>
	</div>
	</section>
