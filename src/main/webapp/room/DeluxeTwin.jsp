...
<link rel="stylesheet" type="text/css"
	href="${contextPath}/css/DeluxeTwin.css?version=1.7">
<link
	href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css"
	rel="stylesheet"
	integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65"
...
<script type="text/javascript">
	function on_submit() {
		window.location.href = '${contextPath}/reserve/reserveDetail.jsp?room=room2'
	}
</script>
...
<body>
	...
	<div class="wrapper">
		<div id="container">
			<img src="${contextPath}/images/main/room2.1.jpg"> <img
				src="${contextPath}/images/main/room2.2.jpg"> <img
				src="${contextPath}/images/main/room2.3.jpg"> <img
				src="${contextPath}/images/main/room2.4.jpg">
			<button id="prev">&lang;</button>
			<button id="next">&rang;</button>
		</div>
	</div>
	<p class="page_title">디럭스 트윈</p>
	<div class=line></div>
	...
	<section class="description_section">
		...
		<div class="description">
			...
			퀸베드, 소파, 테이블로 이루어진 가족전용 객실입니다. <br> <br>
	...
	<div class= wrap id="wrap">
		<button class="btn_alert" style="padding: 23px; " onclick="location.href='${contextPath}/reserveDetail?room=room2'">객실 예약하기</button>
	</div>
	</section>
